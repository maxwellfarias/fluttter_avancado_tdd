...
essa intermediação, ele pode ser excluído e pode ser passado diferetamente a função do repository para o construtor do presenter (repo.loadNextEvent). Na prática, quando se usa o clean arch
no front-end em que as entidades dificilmente terão regras de nogócio, elas serão DTOs, os usecases não precisarão existir em 99% dos casos, pois eles irão apenas repassar chamadas. Isso
inclusive pode ter um pequeno problema de performance por ter mais uma classe no meio e vai gerar mais trabalho para uma coisa que não serve para nada.
